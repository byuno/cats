...
describe('#breedDetails', () => {
  ...
  it('returns nothing for no descrition', () => {
    // We expect it to be a function, but will it be?
    //console.log(breedDetails);
    const expectedDesc = undefined;
    // console.log('expected desciption:', expectedDesc);
    const blankDesciption = breedDetails('blankDoc');
    // console.log('output of black description', blankDesciption);
    assert.equal(expectedDesc, blankDesciption);
  });
